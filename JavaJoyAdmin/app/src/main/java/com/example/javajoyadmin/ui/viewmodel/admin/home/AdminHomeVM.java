package com.example.javajoyadmin.ui.viewmodel.admin.home;
...
import com.example.javajoyadmin.data.repository.admin.AdminHomeRepository;
...
public class AdminHomeVM extends ViewModel {
    ...
    public MutableLiveData<int[]> getDataLineChart() {
