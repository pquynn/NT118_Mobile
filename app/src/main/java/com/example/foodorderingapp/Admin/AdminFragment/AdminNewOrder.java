...
public class AdminNewOrder extends Fragment {
    ...
    private void dataInitialize() {
        ...
        listOrderItem.add(new OrderItemDomain("#order007", 700000, 10));
        listOrderItem.add(new OrderItemDomain("#order008", 700000, 10));
        listOrderItem.add(new OrderItemDomain("#order009", 700000, 10));
        listOrderItem.add(new OrderItemDomain("#order0010", 700000, 10));
    }
}