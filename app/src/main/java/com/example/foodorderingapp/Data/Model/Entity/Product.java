...
public class Product {
    ...
    public Product(String id, String productImage, String idCategory, String productName, int productPrice, String productInfo, List<String> topping, Map<String, Map<String, Object>> productSize) {
        this.id = id;
        this.productImage = productImage;
        this.idCategory = idCategory;
        this.productName = productName;
    ...
    public Map<String, Map<String, Object>> getProductSize() {
        return productSize;
    }

    public void setProductSize(Map<String, Map<String, Object>> productSize) {
        this.productSize = productSize;
    }
