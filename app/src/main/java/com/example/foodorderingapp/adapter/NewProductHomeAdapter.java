...
public class NewProductHomeAdapter extends RecyclerView.Adapter<NewProductHomeAdapter.ViewHolder> {
    ...
    private List<ProductSearchDomain> listNewProduct;

    public NewProductHomeAdapter(Context context, List<ProductSearchDomain> newProductList) {
    ...
    public void onBindViewHolder(@NonNull NewProductHomeAdapter.ViewHolder holder, int position) {
        ProductSearchDomain product = listNewProduct.get(position);
