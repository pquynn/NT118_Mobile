...
public class ProductPopularHomeAdapter extends RecyclerView.Adapter<ProductPopularHomeAdapter.ViewHolder> {
    ...
    private List<ProductSearchDomain> productList;

    public ProductPopularHomeAdapter(Context context, List<ProductSearchDomain> productList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ProductSearchDomain product = productList.get(position);
