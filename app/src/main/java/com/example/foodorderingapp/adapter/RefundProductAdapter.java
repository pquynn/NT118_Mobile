...
public class RefundProductAdapter extends RecyclerView.Adapter<RefundProductAdapter.ViewHolder> {
    ...
    public RefundProductAdapter(ArrayList<OrderDetail> productList){
        this.productList = productList;
    }

    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_refund_prod, parent, false);
