...
import com.example.foodorderingapp.ui.adapter.NewProductHomeAdapter;
...
public class HomeFragment extends Fragment {
    ...
    private List<ProductSearch> getNewProductList() {
        List<ProductSearch> newProductList = new ArrayList<>();

        newProductList.add(new ProductSearch(R.drawable.img4, "Trà sữa ...", "25.000đ"));
