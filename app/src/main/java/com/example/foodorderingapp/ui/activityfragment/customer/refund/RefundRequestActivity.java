...
public class RefundRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedQuantity = new ArrayList<>();
        if (getIntent().getExtras() != null) {
            orderId = getIntent().getExtras().getString("orderId");
            selectedOrderItemId = getIntent().getExtras().getStringArrayList("selectedOrderItemId");
            selectedQuantity = getIntent().getExtras().getIntegerArrayList("selectedQuantity");
        }
        ...
        adapter = new RefundRequestAdapter(orderItemMap, selectedOrderItemId, selectedQuantity, this, selectImgLauncher, selectVideoLauncher);
        ...
        viewModel.getOrderLiveData().observe(this, new Observer<Order>() {
            ...
            public void onChanged(Order order) {
                viewModel.getSelectedOrderItemMapLiveData(selectedOrderItemId, order).observe(RefundRequestActivity.this, new Observer<Map<String, OrderItem>>() {
                    @Override
    ...
    public boolean updateRefundItemMap() {
        ...
        for (int i = 0; i < binding.recyclerViewRefundRequest.getChildCount(); i++) {
            ...
            if (viewHolder != null) {
                ...
                refundItem.setQuantity(Integer.parseInt(viewHolder.getBinding().txtQuantity.getText().toString()));
